...
start "market maker" /d \kdb \q\w32\q.exe qx/marketmaker.q  -p 2010 -qx 2009
::ping 127.0.0.1 -n 2 -w 5000 > nul
::start "user" /d \kdb \q\w32\q.exe qx/user.q -qx 2009
ping 127.0.0.1 -n 2 -w 5000 > nul
start "noise" /d \kdb \q\w32\q.exe qx/noise.q -qx 2009
ping 127.0.0.1 -n 2 -w 5000 > nul
